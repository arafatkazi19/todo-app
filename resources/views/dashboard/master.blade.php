...
<head>
    ...
    <script src="{{asset('/')}}/dashboard/ckeditor/samples/js/sample.js"></script>
    <link rel="stylesheet" href="{{asset('/')}}/dashboard/ckeditor/samples/css/samples.css">
    <link rel="stylesheet" href="{{asset('/')}}/dashboard/ckeditor/samples/toolbarconfigurator/lib/codemirror/neo.css">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-table fa-fw"></i>Manage Order</a>
                    </li>
                    <li>
